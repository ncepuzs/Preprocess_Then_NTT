                    ...
                    unsigned char *sk)
{
  ...
  poly_quarter s00, s01, s10, s11, s01_s, s10_s, s11_s;
  ...
  pt_ntt_bowtiemultiply(&ahat_shat, &ahat, &s00, &s01, &s10, &s11, &s01_s, &s10_s, &s11_s);
                ...
                const unsigned char *coin)
{
  ...
  poly_quarter sprime00, sprime01, sprime10, sprime11, sprime01_s, sprime10_s, sprime11_s;
  ...
  pt_ntt_bowtiemultiply(&uhat, &ahat, &sprime00, &sprime01, &sprime10, &sprime11, &sprime01_s, &sprime10_s, &sprime11_s);
                ...
                const unsigned char *sk)
{
  ...
  pt_ntt_bowtiemultiply(&tmp, &uhat, &s00, &s01, &s10, &s11, &s01_s, &s10_s, &s11_s);
  //poly_invntt(&tmp);
  poly_inv_ptntt(&tmp);
