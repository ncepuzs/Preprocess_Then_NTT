...
void poly_pt_ntt4(poly *p, poly_quarter *p00, poly_quarter *p01, poly_quarter *p10, poly_quarter *p11)
{
    split_poly(p, p00, p01, p10, p11);

    bitrev_vector_128(p00);
    bitrev_vector_128(p10);
    bitrev_vector_128(p01);
    bitrev_vector_128(p11);
...
void poly_pt_ntt7(poly *p, poly_quarter *p00, poly_quarter *p01, poly_quarter *p10, poly_quarter *p11, poly_quarter *p01_s, poly_quarter *p10_s, poly_quarter *p11_s)
{
    ...
    bitrev_vector_128(p01_s);
    bitrev_vector_128(p10_s);
    bitrev_vector_128(p11_s);
